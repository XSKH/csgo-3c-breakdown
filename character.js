var CHARACTER_DATA = {
    ...
    "jumpPhysics": {
        ...
        "htmlKeys": ["value"],
        "data": [
            {"attr":"跳跃高度","value":"~55.5 u","desc":"≈ 1.06m。<span class=\"term\" data-tip=\"sv_jump_impulse = 起跳时赋予玩家的初始垂直速度（u/s），决定跳跃高度\">sv_jump_impulse</span> = 301.993377（初始垂直速度 u/s）"},
            {"attr":"蹲跳高度","value":"~64 u","desc":"≈ 1.22m。跳跃+空中蹲下，可上更高台面"},
            {"attr":"站立碰撞体","value":"72u高 × 32u宽","desc":"高≈1.37m，宽≈0.61m。<span class=\"term\" data-tip=\"眼位（Eye Position）= 摄像机高度，决定玩家视角的垂直位置\">眼位</span>高度 64u≈1.22m"},
            {"attr":"蹲下碰撞体","value":"54u高","desc":"≈1.03m。眼位 46u≈0.88m"},
            {"attr":"重力","value":"<span class=\"term\" data-tip=\"sv_gravity = Source 引擎的重力加速度参数（u/s²），影响跳跃和下落速度\">sv_gravity</span> = 800 u/s²","desc":"≈ 15.24 m/s²（约1.55倍地球重力）"},
            {"attr":"空气加速","value":"<span class=\"term\" data-tip=\"sv_airaccelerate = 空中加速率，控制玩家在空中改变方向的能力，是 Strafe 和 Bhop 的核心参数\">sv_airaccelerate</span> = 12","desc":"空中加速率，<span class=\"term\" data-tip=\"Strafe Jump = 空中平移跳跃技巧，通过空中加速获得额外速度\">Strafe Jump</span>/<span class=\"term\" data-tip=\"Bunny Hop = 连续跳跃技巧，利用空中加速在着地瞬间再次起跳以保持/积累速度\">Bunny Hop</span> 基础"},
            {"attr":"地面加速","value":"<span class=\"term\" data-tip=\"sv_accelerate = 地面加速率，控制玩家从静止到达武器最大速度的快慢\">sv_accelerate</span> = 5.5","desc":"地面加速率"},
            {"attr":"摩擦力","value":"<span class=\"term\" data-tip=\"sv_friction = 地面摩擦系数，数值越高玩家停下越快，影响急停操作的手感\">sv_friction</span> = 5.2","desc":"影响急停速度，数值越高停得越快"},
            {"attr":"掉血落地速度","value":">580 u/s","desc":"≈ 11 m/s。超过此速度着地开始掉血"},
            {"attr":"致死落地速度","value":">1024 u/s","desc":"≈ 19.5 m/s。约 6.3m 高度自由落体"},
            {"attr":"落地精度惩罚","value":"~0.4s","desc":"着地后精度大幅降低，持续约 0.4 秒"},
            {"attr":"蹲下过渡","value":"~0.4s","desc":"站↔蹲动画过渡时长"}
        ]
    }
};
